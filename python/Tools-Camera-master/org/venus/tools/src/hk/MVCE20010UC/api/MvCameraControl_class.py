...
from org.venus.tools.src.hk.MVCE20010UC.api.CameraParams_const import MV_ACCESS_Exclusive

MvCamCtrldll = WinDLL("./api/dll/MvCameraControl.dll")

# MvCamCtrldll = WinDLL("MvCameraControl.dll")
# MvCamCtrldll = WinDLL("C:\Program Files (x86)\Common Files\MVS\Runtime\Win64_x641\MvCameraControl.dll")
